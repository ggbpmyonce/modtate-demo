...
(function () {
  ...
  const Icons = {
    ...
    settingsFilled: (p) => h('svg', { width: p?.size || 18, height: p?.size || 18, viewBox: '0 0 24 24', fill: 'currentColor' },
      h('path', { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M10.1 2.6a2 2 0 0 1 3.8 0l.4 1.2a2 2 0 0 0 2.6 1.1l1.2-.5a2 2 0 0 1 2.7 2.7l-.5 1.2a2 2 0 0 0 1.1 2.6l1.2.4a2 2 0 0 1 0 3.8l-1.2.4a2 2 0 0 0-1.1 2.6l.5 1.2a2 2 0 0 1-2.7 2.7l-1.2-.5a2 2 0 0 0-2.6 1.1l-.4 1.2a2 2 0 0 1-3.8 0l-.4-1.2a2 2 0 0 0-2.6-1.1l-1.2.5a2 2 0 0 1-2.7-2.7l.5-1.2a2 2 0 0 0-1.1-2.6l-1.2-.4a2 2 0 0 1 0-3.8l1.2-.4a2 2 0 0 0 1.1-2.6l-.5-1.2a2 2 0 0 1 2.7-2.7l1.2.5a2 2 0 0 0 2.6-1.1l.4-1.2ZM12 15.6a3.6 3.6 0 1 0 0-7.2 3.6 3.6 0 0 0 0 7.2Z' })),
    downloadFilled: (p) => h('svg', { width: p?.size || 18, height: p?.size || 18, viewBox: '0 0 24 24', fill: 'currentColor' },
      h('path', { d: 'M12 2a1.4 1.4 0 0 1 1.4 1.4v8.1l2.5-2.5a1.4 1.4 0 0 1 2 2l-4.9 4.9a1.4 1.4 0 0 1-2 0L6.1 11a1.4 1.4 0 0 1 2-2l2.5 2.5V3.4A1.4 1.4 0 0 1 12 2Z' }),
      h('path', { d: 'M4 15.5a1.4 1.4 0 0 1 1.4 1.4v1.7c0 .4.3.6.6.6h12c.3 0 .6-.2.6-.6v-1.7a1.4 1.4 0 0 1 2.8 0v1.7a3.4 3.4 0 0 1-3.4 3.4H6a3.4 3.4 0 0 1-3.4-3.4v-1.7A1.4 1.4 0 0 1 4 15.5Z' })),
